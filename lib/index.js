	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function buildPreviews(urls, optimisticUrls, inButton) {
			...
			var _props = this.props,
			    ...
			    noReplacePreviewsWithResponse = _props.noReplacePreviewsWithResponse;
			...
			if (!noReplacePreviewsWithResponse && urls && urls.length > 0 && !(multiple === false && optimisticUrls && optimisticUrls.length > 0)) {
...
ImagesUploader.propTypes = {
	...
	noReplacePreviewsWithResponse: _propTypes2.default.bool,
